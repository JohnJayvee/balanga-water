<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center" style="padding: 0.6rem 5.25rem;">
    <a class="navbar-brand brand-logo" href="{{route('system.dashboard')}}"><img src="{{asset('web/img/balanga-logo-topbar.png')}}" alt="logo" style="width: 50px;"></a>
    <a class="navbar-brand brand-logo-mini" href="{{route('system.dashboard')}}"><img src="{{asset('web/img/balanga-logo-topbar.png')}}" alt="logo" style="width: 50px;"></a>
  </div>
